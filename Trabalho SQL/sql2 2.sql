...
ALTER TABLE IF EXISTS public.tb_produtos
    ADD COLUMN idcategoria integer NOT NULL DEFAULT 1;
*/
...
insert into tb_produtos (descricao,valor,idcategoria) values ('Uva', 2,1);
insert into tb_produtos (descricao,valor,idcategoria) values ('Banana', 1.5,1);
insert into tb_produtos (descricao,valor,idcategoria) values ('Laranja', 3.75,1);
